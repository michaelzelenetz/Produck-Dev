## This is the modified simulator.py. Replace gym-duckietown/simulator.py with this file. 
## This preprocesses the training images. 
...
class Simulator(gym.Env):
    ...
    def __init__(
        ...
        #self.img_array_human = cv2.Canny(self.img_array_human, 200, 100)
    ...
    def _render_img(self, width, height, multi_fbo, final_fbo, img_array, top_down=True):
        ...
        #img_array = cv2.Canny(img_array, 200, 100)
    ...
    def render_obs(self):
        ...
        #observation = cv2.Canny(observation, 200, 100)
    ...
    def render(self, mode='human', close=False):
        ...
        img = (255-img) #Inverse the color
        img = cv2.threshold(img, 150, 255, cv2.THRESH_BINARY)[1] #turn down the colors
